        ...
        <CardHeader className="border-b bg-[#fcfaf7] dark:bg-[#241e17] px-5 py-4">
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex min-w-0 flex-col gap-2 sm:flex-row">
              ...
              <button type="button" onClick={() => { setSearch(searchDraft.trim()); setFilter('all'); setPage(1); }} className="h-10 rounded-lg border border-input bg-white px-5 text-sm font-medium hover:bg-accent dark:bg-card xl:hidden">Search</button>
